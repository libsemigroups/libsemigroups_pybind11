...
def test_to_InversePresentation_034():
...
def test_to_InversePresentation_035():
    ip = InversePresentation("abc")
    ip.inverses("cba")
    presentation.add_rule(ip, "aaa", "b")
    presentation.add_rule(ip, "bac", "cab")
...
def test_to_InversePresentation_036():
    p = Presentation("abc")
