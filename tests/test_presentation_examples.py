...
def test_monoid_status():
    ...
    assert examples.order_preserving_cyclic_inverse_monoid_Fer22(5).contains_empty_word()
    ...
    assert examples.orientation_preserving_reversing_monoid_AR00(5).contains_empty_word()
