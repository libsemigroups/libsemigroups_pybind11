...
_RETURN_TYPE_TO_CONVERTER_FUNCTION = {
    ...
    (_KnuthBendix, "Set", _Order.recursive): _to_knuth_bendix_RevRPOSet,
    (_KnuthBendix, "Trie", _Order.recursive): _to_knuth_bendix_RevRPOTrie,
    (_KnuthBendix, list[int], "Set", _Order.recursive): _to_knuth_bendix_word_RevRPOSet,
    (_KnuthBendix, list[int], "Trie", _Order.recursive): _to_knuth_bendix_word_RevRPOTrie,
    (_KnuthBendix, str, "Set", _Order.recursive): _to_knuth_bendix_string_RevRPOSet,
    (_KnuthBendix, str, "Trie", _Order.recursive): _to_knuth_bendix_string_RevRPOTrie,
