...
class KnuthBendix(_CongruenceCommon):
    ...
    _py_template_params_to_cxx_type = {
        ...
        (list[int], "Trie", _Order.rpo): _KnuthBendixWordRPOTrie,
        (str, "Trie", _Order.rpo): _KnuthBendixStringRPOTrie,
        (list[int], "Set", _Order.rpo): _KnuthBendixWordRPOSet,
        (str, "Set", _Order.rpo): _KnuthBendixStringRPOSet,
        (list[int], "Trie", _Order.rev_rpo): _KnuthBendixWordRevRPOTrie,
        (str, "Trie", _Order.rev_rpo): _KnuthBendixStringRevRPOTrie,
        (list[int], "Set", _Order.rev_rpo): _KnuthBendixWordRevRPOSet,
        (str, "Set", _Order.rev_rpo): _KnuthBendixStringRevRPOSet,
    }
