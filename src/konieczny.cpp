...
This function constructs a :any:`KoniecznyBMat8` instance generated by the specified
...
.. seealso::  :any:`KoniecznyBMat8`.)pbdoc");
      ...
      thing2.def(
          ...
          py::arg("x"),
          R"pbdoc(
:sig=(self: KoniecznyBMat8DClass, x: Element) -> bool:
