...
namespace libsemigroups {
  ...
  void init_knuth_bendix(py::module &m) {
    py::class_<libsemigroups::fpsemigroup::KnuthBendix>(m, "KnuthBendix")
        .def(py::init<>())
        .def("set_alphabet",
    ...
    std::string. )pbdoc")
        .def("add_rule",
           ...
           :Parameters: - **u** (??) - the left-hand side of the rule being
    added.
                        - **v** (??) - the right-hand side of the rule being
    added.
    ...
    generator of the finitely presented semigroup represented by this.
    ...
    same element of the finitely presented semigroup represented by this.
    ...
    .def("add_rules",
         ...
         R"pbdoc(
           ...
           :Parameters: **S** (??) - a FroidurePin object representing a
    semigroup.
    ...
    .def("add_rules",
         ...
         R"pbdoc(
           ...
           :Parameters: **rels** (??) - a vector of
    FpSemigroupInterface::rule_type.
    ...
    .def("set_identity",
         ...
         R"pbdoc(
           ...
           :Parameters: **id** (??) - the index of the character to be the
    identity.
    ...
    .def("set_identity",
         ...
         R"pbdoc(
           ...
           :Parameters: **id** (??) - a string containing the character to be
    the identity.
    ...
    .def("cbegin_rules",
         &libsemigroups::fpsemigroup::KnuthBendix::cbegin_rules,
         R"pbdoc(
    ...
    .def("cend_rules",
         &libsemigroups::fpsemigroup::KnuthBendix::cend_rules,
         R"pbdoc(
    ...
    by this.
           ...
           :Returns: A const reference to the alphabet, a value of type
    std::string. )pbdoc")
    .def( "alphabet", py::overload_cast<size_t>(
            &libsemigroups::fpsemigroup::KnuthBendix::alphabet, py::const_),
        py::arg("i"),
        R"pbdoc(
    ...
    .def("active_rules",
         ...
         R"pbdoc(
           ...
           :return: A copy of the currently active rules, a value of type
    std::vector<rule_type>. )pbdoc") .def("confluent",
         &libsemigroups::fpsemigroup::KnuthBendix::confluent,
         R"pbdoc(
           Check if the KnuthBendix instance is confluent.

           :return: true if the KnuthBendix instance is confluent and false if
    it is not. )pbdoc") .def("is_obviously_finite",
         &libsemigroups::fpsemigroup::KnuthBendix::is_obviously_finite,
         R"pbdoc(
           Return true if the finitely presented semigroup represented by this
    is obviously finite, and false if it is not obviously finite.
    ...
    .def("is_obviously_infinite",
         ...
         R"pbdoc(
           Return true if the finitely presented semigroup represented by this
    is obviously infinite, and false if it is not obviously infinite.
    ...
    .def("froidure_pin",
         ...
         R"pbdoc(
           Returns a FroidurePin instance isomorphic to the finitely presented
    semigroup defined by this.
    ...
    .def("has_froidure_pin",
         ...
         R"pbdoc(
           Returns true if a FroidurePin instance isomorphic to the finitely
    presented semigroup defined by this has already been computed, and false if
    not.
    ...
    one.
           ...
           :return: A const reference to the identity, a value of type
    std::string. )pbdoc") .def("inverses",
         &libsemigroups::fpsemigroup::KnuthBendix::inverses,
         R"pbdoc(
           Returns the inverses of this, or throws an exception if there aren't
    any.

           :return: A const reference to the inverses, a value of type
    std::string. )pbdoc") .def("gilman_digraph",
    ...
    .def("report_every",
         ...
         R"pbdoc(
           ...
           :Parameters: **t** (??) - the amount of time (in nanoseconds) between
    reports.
    ...
    .def("running",
         ...
         R"pbdoc(
           ...
           :return: true if Runner::run is in the process to run and false it is
    not. )pbdoc") .def("equal_to",
         ...
         R"pbdoc(
           ...
           :Parameters: - **u** (??) - a libsemigroups::word_type consisting of
    indices of the generators of the finitely presented semigroup.
                        - **v** (??) - a libsemigroups::word_type consisting of
    indices of the generators of the finitely presented semigroup.

           :Returns: true if the words u and v represent the same element of the
    finitely presented semigroup, and false otherwise. )pbdoc") .def("equal_to",
         py::overload_cast<std::string const &, std::string const &>(
             &libsemigroups::fpsemigroup::KnuthBendix::equal_to),
         py::arg("u"),
         py::arg("v"),
         R"pbdoc(
           ...
           :Parameters: - **u** (??) - a string over the alphabet of the
    finitely presented semigroup.
                        - **v** (??) - a string over the alphabet of the
    finitely presented semigroup.

           :Returns: true if the strings u and v represent the same element of
    the finitely presented semigroup, and false otherwise. )pbdoc")
    .def("equal_to",
         py::overload_cast<word_type const &, word_type const &>(
             &libsemigroups::fpsemigroup::KnuthBendix::equal_to),
         py::arg("u"),
    ...
    indices of the generators of the finitely presented semigroup.
           ...
           :Returns: true if the words u and v represent the same element of the
    finitely presented semigroup, and false otherwise. )pbdoc") .def("rewrite",
    ...
    The parameter w must be a std::string consisting of letters in alphabet().
           ...
           :Returns: the normal form of the parameter w, a value of type
    std::string. )pbdoc") .def("normal_form", py::overload_cast<word_type const
    &>( &libsemigroups::fpsemigroup::KnuthBendix::normal_form), py::arg("w"),
         R"pbdoc(
           Returns a normal form for a libsemigroups::word_type.

           :Parameters: **w** (??) - the word whose normal form we want to find.
    The parameter w must be a libsemigroups::word_type consisting of indices of
    the generators of the finitely presented semigroup that this represents.

           :Returns: the normal form of the parameter w, a value of type
    libsemigroups::word_type. )pbdoc") .def("normal_form",
         py::overload_cast<std::initializer_list<letter_type>>(
             &libsemigroups::fpsemigroup::KnuthBendix::normal_form),
         py::arg("w"),
         R"pbdoc(
