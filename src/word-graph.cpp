...
namespace libsemigroups {
  namespace libsemigroups_pybind11 {
    ...
    //    // libsemigroups::action_digraph_helper::make, which can't be used
    //    because
    ...
    //        depth-first-search.)pbdoc") .value(
    //            "matrix",
    //            algorithm::matrix,
    ...
    //
    //               :Parameters: - **m** (int) the number of nodes in the
    //               digraph
    //                              (default: ``0``).
    ...
    //             py::overload_cast<node_type const>(
    //                 &ActionDigraph<size_t>::number_of_paths_algorithm,
    //                 py::const_),
    //             py::arg("source"),
    //             R"pbdoc(
    ...
    //               :py:obj:`ActionDigraph.algorithm`.
    //             )pbdoc")
    //        .def("number_of_paths",
    //             py::overload_cast<node_type const>(
    ...
    //               size_t const&                mn,
    //               size_t const&                mx) {
    //              return py::make_iterator(ad.cbegin_pstilo(source, target,
    //              mn, mx),
    //                                       ad.cend_pstilo());
    //            },
    //            py::arg("source"),
    ...
    //            py::arg("out_degree"),
    //            R"pbdoc(
    //              Constructs a random :py:class:`ActionDigraph` with the
    ...
    //            py::arg("nr_edges"),
    //            R"pbdoc(
    //              Constructs a random acyclic :py:class:`ActionDigraph` with
    ...
    //          )pbdoc");
    //    m.def("make",
    //          // see docs/source/api/digraph-helper.rst for the doc, it's
    //          there
