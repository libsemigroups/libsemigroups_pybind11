# libsemigroups_pybind11 - Version 0.1.4
...
To build `libsemigroups_pybind11` from a release archive:
    ...
    curl -L -O https://github.com/libsemigroups/libsemigroups_pybind11/releases/latest/download/libsemigroups_pybind11-0.1.4.tar.gz
    tar -xf libsemigroups_pybind11-0.1.4.tar.gz 
    rm -f libsemigroups_pybind11-0.1.4.tar.gz
    cd libsemigroups_pybind11-0.1.4
    pip install .
